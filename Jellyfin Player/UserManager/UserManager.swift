...
class UserManager: UserManaging {
    ...
    var embyAuthHeader: NetworkRequestHeaderValue {
        ...
        return NetworkRequestHeaderValue(header: "X-Emby-Authorization", value: "Emby \(userId)Client=\"Jellyfin Player SPAM\", Device=\"iPhone\", DeviceId=\"\(deviceId)\", Version=\"1.0.0\"")
    }
